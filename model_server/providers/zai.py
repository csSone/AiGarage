...
class ZaiProvider(BaseProvider):
    ...
    Uses the OpenAI-compatible SDK with custom base URL for ZAI.
    """

    DEFAULT_BASE_URL = "https://api.zai.ai/v1"
    ...
    def __init__(self, api_key: str, base_url: str | None = None):
        ...
        Args:
            api_key: ZAI API key
            base_url: Custom base URL (defaults to https://api.zai.ai/v1)
        """
